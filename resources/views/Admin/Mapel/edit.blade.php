    ...
    <div class="col-6">
      <div class="card">
        <div class="card-header">
          <h5>Update Data Mata Pelajaran</h5>
        </div>
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" id="nama" name="nama_mapel" value="{{ $mapel->nama_mapel ?? '' }}" class="form-control @error('nama_mapel') is-invalid @enderror">
            @error('nama_mapel')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
